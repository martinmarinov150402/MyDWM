...
static const char *fonts[]          = {"Hack Regular Nerd Font:size=16"};
static const char dmenufont[]       = "Hack Regular Nerd Font:size=12";
...
static const char *spotifyplay[] = {"dbus-send","--print-reply","--dest=org.mpris.MediaPlayer2.spotify","/org/mpris/MediaPlayer2","org.mpris.MediaPlayer2.Player.PlayPause", NULL };
...
static const char *veronika[] = {"mplayer","https://play.global.audio/veronika.opus",NULL};
static const char *killmplayer[] = {"killall", "mplayer",NULL};
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,			XK_n,		spawn, 		{.v=spotifynext} },
	{ MODKEY|ControlMask,			XK_p,		spawn,		{.v=spotifyprev} },
	{ MODKEY|ControlMask,			XK_t,		spawn,		{.v=spotifyplay} },
	//===================================================================
